...
<p>
  <img src="https://skillicons.dev/icons?i=java,php,laravel,python,flutter,firebase,react,nextjs,mysql,git,js,html,css,tailwind,kotlin,c,dart,go,spring,postgres,angular" />
</p>
...
* 📱 **CHOP’** – Full-stack mobile app to help students find internships and jobs (Flutter, Laravel, SQL)  
...
**Web Developer Intern – Alvarium (2025)**  
Backend development with Laravel, AI API integration (GPT), email processing (IMAP), and database design.

---

## 🌍 Languages

French (B2) • English (B2) • Arabic (Native) • Spanish (B1) • German (A2)
...
💻 Portfolio: [Hachim's portfolio](https://portfolio-hachim-elomaris-projects.vercel.app/)
